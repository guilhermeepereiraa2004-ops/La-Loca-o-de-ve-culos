  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
        {stats.map((stat) => (
          <div key={stat.label} className="bg-[#0a0a0a] p-8 rounded-2xl border border-neutral-800 shadow-sm hover:border-[#D4AF37]/30 transition-all group">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 bg-[#0a0a0a] rounded-3xl border border-neutral-800 shadow-sm overflow-hidden">
          ...
          <div className="divide-y divide-neutral-50">
            {alerts.map((alert) => (
              <div key={alert.title} className="p-6 flex items-center justify-between hover:bg-black transition-colors cursor-pointer group">
                <div className="flex items-center gap-4">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center ${alert.type === 'critical' ? 'bg-red-500/10 text-red-500' :
        ...
        <div className="bg-neutral-900 rounded-3xl p-8 text-white relative overflow-hidden">
          <div className="relative z-10">
            ...
            <button className="w-full mt-12 py-4 bg-[#D4AF37] text-white font-black uppercase tracking-widest text-[10px] hover:bg-[#0a0a0a] transition-all">
