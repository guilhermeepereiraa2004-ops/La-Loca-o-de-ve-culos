...
const InvestorPayoutModal = ({ investor, amount, referenceMonth, onClose, onSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-neutral-950/70 backdrop-blur-sm p-4"
      onClick={onClose}>
      <div className="bg-[#0a0a0a] rounded-3xl shadow-2xl w-full max-w-md overflow-hidden"
        ...
        <div className="bg-neutral-900 p-8 relative">
          ...
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 bg-[#D4AF37] rounded-2xl flex items-center justify-center text-white font-black text-2xl shadow-lg shadow-[#D4AF37]/30">
            ...
            <div>
              ...
              <p className="text-[9px] text-[#D4AF37] font-black uppercase tracking-widest mt-0.5">
        ...
        {done ? (
          ...
          <div className="p-12 flex flex-col items-center text-center gap-4">
            ...
            <h5 className="text-xl font-black text-white tracking-tight">Repasse Registrado!</h5>
          ...
          <div className="p-8 space-y-6">
            ...
            <div className="p-6 bg-black rounded-2xl border border-neutral-800">
              ...
              <p className="text-3xl font-black text-white tracking-tighter">
                <span className="text-lg text-[#D4AF37] mr-1">R$</span>
            ...
            <div>
              ...
              <div className="flex gap-2">
                <div className="flex-1 bg-black border border-neutral-800 rounded-2xl px-4 py-3">
                  <p className="text-sm font-black text-[#D4AF37] break-all">{pixKey}</p>
                </div>
                {investor?.pix && (
                  <button onClick={handleCopyPix}
                    className="w-12 h-12 bg-neutral-900 rounded-xl flex items-center justify-center hover:bg-[#D4AF37] transition-colors shrink-0">
                    {copied
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full bg-black text-white border border-neutral-800 rounded-2xl p-4 text-sm font-medium outline-none focus:ring-2 focus:ring-[#D4AF37]/20 resize-none transition-all"
              />
            </div>

            {/* Alerta de duplicata */}
            {duplicateWarning && (
              <div className="p-4 bg-amber-500/10 border border-amber-100 rounded-2xl flex gap-3">
            ...
            <button
              ...
              disabled={loading}
              className="w-full py-5 bg-[#D4AF37] text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-2xl hover:bg-neutral-900 hover:text-white transition-all shadow-lg flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed">
              {loading
