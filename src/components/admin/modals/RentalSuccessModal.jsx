...
const RentalSuccessModal = ({ onClose }) => {
  return (
    <div className="fixed inset-0 z-[500] flex items-center justify-center p-4 md:p-8 animate-in fade-in duration-500">
      ...
      <div className="bg-[#0a0a0a] w-full max-w-md rounded-[3.5rem] shadow-2xl relative z-10 overflow-hidden text-center">
        <div className="bg-neutral-900 p-12 relative overflow-hidden">
          <div className="absolute inset-0 bg-[#D4AF37]/10" />
          <div className="w-24 h-24 bg-[#D4AF37] rounded-2xl flex items-center justify-center mx-auto mb-8 shadow-2xl shadow-[#D4AF37]/30 relative z-10 animate-bounce">
        ...
        <div className="p-10">
          ...
          <button onClick={onClose} className="w-full py-6 bg-neutral-950 text-white text-[10px] uppercase tracking-[0.3em] font-black rounded-2xl hover:bg-[#D4AF37] transition-all shadow-xl">
            Concluir
          </button>
        </div>
      </div>
