...
const RentalRenewalModal = ({ rental, onClose, onConfirm }) => {
  ...
  return (
    <div className="fixed inset-0 z-[800] flex items-center justify-center p-0 md:p-8 animate-in fade-in duration-500">
      ...
      <div className="bg-white w-full max-w-2xl h-full md:h-auto md:max-h-[90vh] rounded-none md:rounded-[3rem] shadow-2xl relative z-10 overflow-hidden flex flex-col animate-in zoom-in-95 duration-500">
        {/* Header */}
        <div className="p-10 border-b border-neutral-100 flex justify-between items-center bg-white shrink-0">
          <div className="flex items-center gap-6">
            <div className="w-16 h-16 bg-[#C5A059] rounded-[2rem] flex items-center justify-center text-neutral-950 shadow-2xl shadow-[#C5A059]/30 transform -rotate-3">
              <RefreshCw size={28} />
            </div>
            <div>
              <EditorialLabel className="text-[#C5A059] mb-1">Ajuste de Vigência</EditorialLabel>
              <h4 className="text-3xl font-black uppercase tracking-tighter text-neutral-900">Renovar Contrato</h4>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-10 space-y-10">
          {/* Card Resumo */}
          <div className="bg-neutral-900 p-8 rounded-[2rem] text-white border border-neutral-800 space-y-6 relative overflow-hidden">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
              <select
                ...
                className="w-full bg-neutral-50 border-none p-5 rounded-2xl outline-none focus:ring-2 focus:ring-[#C5A059]/20 transition-all font-bold text-neutral-900 cursor-pointer text-sm"
              >
          ...
          <div className="bg-neutral-50 rounded-[2.5rem] border border-neutral-100 p-8 grid grid-cols-1 sm:grid-cols-3 gap-6 items-center text-center sm:text-left">
            <div className="space-y-2">
              <p className="text-[9px] uppercase tracking-widest text-neutral-400 font-black">Data de Término Atual</p>
              <h6 className="text-lg font-black text-neutral-700">{dates.currentEnd}</h6>
              <span className="inline-block text-[9px] font-bold text-neutral-400 uppercase">{dates.currentWeeks} semanas totais</span>
            </div>

            <div className="flex justify-center text-[#C5A059] shrink-0">
            ...
            <div className="space-y-2">
              ...
              <span className="inline-block text-[9px] font-black text-emerald-500 bg-emerald-50 px-2.5 py-1 rounded-full uppercase">
        ...
        <div className="p-10 border-t border-neutral-50 bg-neutral-50/30 flex justify-end gap-6 shrink-0">
          ...
          <button
            ...
            className="px-16 py-5 bg-neutral-900 text-[#C5A059] text-[10px] font-black uppercase tracking-[0.3em] rounded-2xl hover:bg-[#C5A059] hover:text-white transition-all shadow-2xl flex items-center gap-3 disabled:opacity-50"
            disabled={isSubmitting}
          >
