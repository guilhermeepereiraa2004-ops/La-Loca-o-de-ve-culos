  ...
  return (
    <div className="fixed inset-0 z-[500] flex items-center justify-center p-0 md:p-8 animate-in fade-in duration-500">
      ...
      <div className="bg-[#f8f9fa] w-full max-w-[1400px] h-full md:h-auto md:max-h-[95vh] md:rounded-[3.5rem] shadow-2xl relative z-10 overflow-hidden flex flex-col animate-in zoom-in-95 duration-500 border border-white/20">
        ...
        {/* Modern Glass Header */}
        <header className="px-8 md:px-12 py-8 bg-white/80 backdrop-blur-md border-b border-neutral-800 flex flex-col md:flex-row justify-between items-center gap-6 sticky top-0 z-30">
          <div className="flex items-center gap-6">
            <div className="w-16 h-16 bg-neutral-900 rounded-3xl flex items-center justify-center text-[#D4AF37] shadow-2xl shadow-[#D4AF37]/20 transform -rotate-3 hover:rotate-0 transition-all duration-500">
              <ClipboardList size={28} />
            </div>
            <div>
              <div className="flex items-center gap-3 mb-1.5">
                <EditorialLabel className="text-[#D4AF37] tracking-[0.2em] text-[10px]">Dossiê de Locação</EditorialLabel>
                <div className={`flex items-center gap-1.5 px-3 py-1 rounded-full text-[8px] font-black uppercase tracking-widest border transition-colors ${
                  ...
                  <div className={`w-1.5 h-1.5 rounded-full ${rental.status === 'Ativo' ? 'bg-emerald-500 animate-pulse' : 'bg-[#0a0a0a]'}`} />
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            ...
            <button 
              ...
              className="flex-1 md:flex-none flex items-center justify-center gap-3 px-6 py-4 bg-neutral-900 text-[#D4AF37] text-[10px] font-black uppercase tracking-widest rounded-2xl hover:bg-[#D4AF37] hover:text-white transition-all shadow-xl group"
            >
            ...
            <button onClick={onClose} className="w-14 h-14 bg-black flex items-center justify-center rounded-full hover:bg-neutral-100 transition-all text-neutral-400 hover:text-white border border-neutral-800">
              <X size={24} />
            </button>
          </div>
        </header>
        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-12 space-y-12">
          ...
          <section className="bg-[#0a0a0a] p-8 md:p-10 rounded-3xl border border-neutral-800 shadow-sm relative overflow-hidden">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 relative z-10">
              <div className="space-y-1 border-l-2 border-[#D4AF37] pl-6">
                <p className="text-[9px] uppercase font-black text-neutral-400 tracking-[0.2em]">Início</p>
                <p className="text-lg font-black text-white tracking-tight">{dates.start}</p>
                <p className="text-[9px] font-bold text-neutral-400 uppercase">{dates.weekday}</p>
              </div>
              <div className="space-y-1 border-l-2 border-neutral-800 pl-6">
                <p className="text-[9px] uppercase font-black text-neutral-400 tracking-[0.2em]">
                  {dates.isClosed ? 'Término' : 'Término Previsto'}
                </p>
                <p className="text-lg font-black text-white tracking-tight">{dates.end}</p>
              ...
              <div className="space-y-1 border-l-2 border-neutral-800 pl-6">
                ...
                <p className="text-lg font-black text-white tracking-tight">{rental.durationWeeks || rental.period || 0} Semanas</p>
              ...
              <div className="space-y-1 border-l-2 border-neutral-800 pl-6">
                ...
                <p className="text-lg font-black text-[#D4AF37] tracking-tight">{formatCurrency(rental.value)}</p>
            ...
            {/* Progress Visualizer */}
            <div className="mt-10">
              <div className="h-3 w-full bg-black rounded-full overflow-hidden flex p-1 border border-neutral-800">
                <div 
                  className={`h-full rounded-full shadow-lg transition-all duration-1000 ${
                    dates.isClosed 
                      ? 'bg-neutral-900' 
                      : 'bg-gradient-to-r from-neutral-900 to-[#D4AF37]'
                  }`}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            <div className="lg:col-span-8 space-y-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {/* Conductor Bento */}
                <div className="bg-[#0a0a0a] p-8 rounded-3xl border border-neutral-800 shadow-sm space-y-8 flex flex-col justify-between">
                  <div>
                    <div className="flex items-center gap-3 mb-8">
                      ...
                      <h5 className="text-[10px] font-black uppercase tracking-[0.2em] text-white">Perfil do Condutor</h5>
                    </div>
                    <div className="space-y-6">
                      <div>
                        <p className="text-[8px] uppercase font-black text-neutral-400 mb-1">Nome Completo</p>
                        <h4 className="text-xl font-black text-white tracking-tighter leading-tight">{rental.user || rental.userName || '---'}</h4>
                      </div>
                      <div className="grid grid-cols-2 gap-4">
                        <div className="bg-black p-4 rounded-2xl">
                          ...
                          <div className="flex items-center gap-2 text-white font-bold text-[11px]">
                            <Phone size={12} className="text-[#D4AF37]" /> {rental.clientPhone || rental.phone || '---'}
                          </div>
                        </div>
                        <div className="bg-black p-4 rounded-2xl">
                          <p className="text-[7px] uppercase font-black text-neutral-400 mb-1">E-mail</p>
                          <div className="flex items-center gap-2 text-white font-bold text-[11px] truncate">
                            <Mail size={12} className="text-[#D4AF37]" /> {rental.email || '---'}
                          </div>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="pt-6 border-t border-neutral-800 grid grid-cols-2 gap-y-6 gap-x-4">
                    <div>
                      <p className="text-[7px] uppercase font-black text-neutral-400 mb-1">CPF</p>
                      <p className="text-sm font-black text-white">{rental.cpf || '---'}</p>
                    </div>
                    <div>
                      <p className="text-[7px] uppercase font-black text-neutral-400 mb-1">RG</p>
                      <p className="text-sm font-black text-white">{rental.rg || '---'}</p>
                    </div>
                    <div>
                      <p className="text-[7px] uppercase font-black text-neutral-400 mb-1">Estado Civil</p>
                      <p className="text-sm font-black text-white">{rental.estadoCivil || '---'}</p>
                    </div>
                    <div>
                      <p className="text-[7px] uppercase font-black text-neutral-400 mb-1">Nacionalidade</p>
                      <p className="text-sm font-black text-white">{rental.nacionalidade || '---'}</p>
                    </div>
                    <div>
                      <p className="text-[7px] uppercase font-black text-neutral-400 mb-1">Número CNH</p>
                      <p className="text-sm font-black text-white">{rental.cnhNumber || rental.cnh || '---'}</p>
                    </div>
                    <div>
                      <p className="text-[7px] uppercase font-black text-neutral-400 mb-1">Registro CNH</p>
                      <p className="text-sm font-black text-white">{rental.cnhRegisterNumber || '---'}</p>
                    </div>
                    <div>
                      <p className="text-[7px] uppercase font-black text-neutral-400 mb-1">Validade CNH</p>
                      <p className="text-sm font-black text-white">{rental.cnhValidity ? new Date(rental.cnhValidity + 'T12:00:00').toLocaleDateString('pt-BR') : '---'}</p>
                    </div>
                    <div>
                      <p className="text-[7px] uppercase font-black text-neutral-400 mb-1">CEP</p>
                      <p className="text-sm font-black text-white">{rental.cep || '---'}</p>
                    </div>
                    <div className="col-span-2">
                      <p className="text-[7px] uppercase font-black text-neutral-400 mb-1">Cidade / UF</p>
                      <p className="text-sm font-black text-white">{rental.cidadeUf || '---'}</p>
                    </div>
                    <div className="col-span-2">
                      <p className="text-[7px] uppercase font-black text-neutral-400 mb-1">Endereço Residencial</p>
                      <p className="text-sm font-black text-white">{rental.address || '---'}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-neutral-900 p-8 rounded-3xl shadow-2xl relative overflow-hidden group">
                  ...
                  <div className="relative z-10 flex flex-col justify-between h-full">
                    <div>
                      <div className="flex items-center gap-3 mb-8">
                        <div className="w-10 h-10 bg-[#D4AF37] text-white rounded-2xl flex items-center justify-center shadow-lg shadow-[#D4AF37]/20">
                          <Car size={20} />
                        </div>
                        <h5 className="text-[10px] font-black uppercase tracking-[0.2em] text-[#D4AF37]">Veículo Vinculado</h5>
                      </div>
                      <div className="aspect-video rounded-2xl overflow-hidden mb-6 border border-white/5 bg-neutral-800">
                        <img 
              ...
              <section className="bg-[#0a0a0a] p-10 rounded-3xl border border-neutral-800 shadow-sm space-y-10">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-amber-500/10 text-[#D4AF37] rounded-2xl flex items-center justify-center">
                      <Receipt size={20} />
                    </div>
                    <h5 className="text-[10px] font-black uppercase tracking-[0.2em] text-white">Extrato Financeiro do Contrato</h5>
                  </div>
                  {onPayCaucao && (
                    <button onClick={onPayCaucao} className="text-[10px] font-black uppercase tracking-widest text-[#D4AF37] hover:text-white transition-colors flex items-center gap-2 group">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="p-6 bg-[#f8f9fa] rounded-3xl border border-neutral-800">
                    <p className="text-[8px] uppercase font-black text-neutral-400 mb-2">Aluguel Semanal</p>
                    <div className="flex items-baseline gap-1">
                      <span className="text-lg font-black text-white">{formatCurrency(rental.value)}</span>
                  ...
                  <div className="p-6 bg-[#f8f9fa] rounded-3xl border border-neutral-800">
                    ...
                    <div className="flex items-baseline gap-1">
                      <span className="text-lg font-black text-white">{formatCurrency(rental.tireTax || 25)}</span>
                      <span className="text-[8px] font-black text-neutral-400 uppercase">/ sem</span>
                    </div>
                  </div>
                ...
                <div className="space-y-4 pt-6 border-t border-neutral-50">
                  <div className="flex justify-between items-center text-[10px]">
                    ...
                    <span className="font-black text-white">{formatCurrency(rental.depositPaid)}</span>
                  </div>
                  <div className="flex justify-between items-center text-[10px]">
                  ...
                  <div className="flex justify-between items-center text-[11px] pt-4 border-t border-neutral-50">
                    <span className="text-white font-black uppercase tracking-[0.2em]">Total Bruto do Contrato</span>
              ...
              <section className="space-y-8">
                <div className="flex items-center gap-3">
                  ...
                  <h5 className="text-[10px] font-black uppercase tracking-[0.2em] text-white">Certificados de Vistoria</h5>
                </div>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {rentalInspections.length > 0 ? (
                    rentalInspections.map((ins) => (
                      <div key={ins.id} className="bg-[#0a0a0a] p-8 rounded-3xl border border-neutral-800 shadow-sm space-y-6 hover:border-[#D4AF37]/30 transition-all group">
                        <div className="flex justify-between items-start">
                          <div className="flex items-center gap-3">
                            <div className={`px-4 py-2 rounded-xl text-[8px] font-black uppercase tracking-widest ${
                              ...
                              ins.type === 'Devolução' ? 'bg-[#D4AF37] text-white' : 
                              'bg-neutral-100 text-neutral-500'
                            }`}>
                              {ins.type}
                            </div>
                            <div>
                              <p className="text-xs font-black text-white">{new Date(ins.date + 'T12:00:00').toLocaleDateString('pt-BR')}</p>
                          ...
                          }} className="w-10 h-10 bg-black rounded-xl flex items-center justify-center text-neutral-400 hover:bg-neutral-900 hover:text-white transition-all">
                            <ImageIcon size={18} />
                          </button>
                        </div>
                        ...
                        <div className="flex gap-2 overflow-x-auto pb-4 custom-scrollbar">
                          {Object.entries(ins.photos || {})
                            ...
                            .map(([key, photo], i) => (
                              <div key={i} className="w-20 h-20 rounded-2xl overflow-hidden shrink-0 border border-neutral-800 cursor-pointer hover:opacity-80 transition-opacity" onClick={() => setSelectedImage(getFileUrl(photo))}>
                          ...
                          {ins.photos?.additional && ins.photos.additional.map((photo, i) => (
                            <div key={`add-${i}`} className="w-20 h-20 rounded-2xl overflow-hidden shrink-0 border-2 border-dashed border-[#D4AF37]/40 cursor-pointer hover:opacity-80 transition-opacity relative" onClick={() => setSelectedImage(getFileUrl(photo))}>
                              <img src={getFileUrl(photo)} className="w-full h-full object-cover" alt="Vistoria Adicional" />
                              <span className="absolute bottom-1 right-1 bg-[#D4AF37] text-[8px] font-black text-white px-1 rounded shadow">+</span>
                            </div>
                          ))}
                        </div>
                        <div className="bg-black p-4 rounded-2xl">
                    ...
                    <div className="col-span-2 p-16 bg-[#0a0a0a] border-2 border-dashed border-neutral-800 rounded-3xl text-center space-y-4">
                      <div className="w-16 h-16 bg-black rounded-full flex items-center justify-center mx-auto text-neutral-200">
                        <ClipboardList size={32} />
                      </div>
                      <div>
                        <p className="text-[10px] font-black text-white uppercase tracking-widest">Sem vistorias vinculadas</p>
            ...
            <div className="lg:col-span-4 space-y-8">
              ...
              {/* STATUS & ACTIONS CARD */}
              <div className="bg-[#0a0a0a] p-8 rounded-3xl border border-neutral-800 shadow-sm space-y-8">
                <h5 className="text-[10px] font-black uppercase tracking-[0.2em] text-neutral-400">Ações do Administrador</h5>
                
                <div className="space-y-4">
                  {/* Upload Label */}
                  <label className={`w-full flex items-center gap-4 p-5 rounded-2xl transition-all cursor-pointer group border-2 border-dashed ${
                    isUploading
                      ? 'bg-amber-500/10/50 border-amber-300 text-amber-700 animate-pulse pointer-events-none'
                      : rental.docs?.signedContract 
                        ? 'bg-emerald-500/10/50 border-emerald-300 text-emerald-700 hover:bg-emerald-500/10 hover:border-emerald-400' 
                        : 'bg-black border-neutral-700 text-neutral-400 hover:border-[#D4AF37] hover:bg-[#0a0a0a]'
                  }`}>
                    <div className={`w-12 h-12 rounded-2xl flex items-center justify-center shadow-lg ${
                      isUploading
                        ? 'bg-amber-500 text-white'
                        : rental.docs?.signedContract ? 'bg-emerald-500 text-white' : 'bg-[#0a0a0a] text-neutral-400'
                    }`}>
                      {isUploading ? (
                  ...
                  {onGoToVistorias && !inspections.some(ins => ins.vehiclePlate === (rental.vehiclePlate || rental.plate) && ins.type === 'Entrega') && (
                    <button 
                      ...
                      className="w-full flex items-center gap-4 p-5 bg-[#D4AF37] text-white rounded-2xl hover:bg-neutral-950 transition-all shadow-xl shadow-[#D4AF37]/20"
                    >
                  ...
                  {rental.status === 'Ativo' && onRenewContract && (
                    <button 
                      ...
                      className="w-full flex items-center gap-4 p-5 bg-neutral-900 text-[#D4AF37] rounded-2xl hover:bg-[#D4AF37] hover:text-white transition-all shadow-xl shadow-neutral-900/10"
                    >
              ...
              {(rental.status === 'Encerrado' || rental.docs?.terminationTerm) && (
                <div className="bg-neutral-900 p-10 rounded-3xl shadow-2xl relative overflow-hidden group border border-[#D4AF37]/20">
                  <div className="absolute top-0 right-0 w-32 h-32 bg-[#D4AF37]/10 rounded-full blur-3xl" />
                  <div className="relative z-10 space-y-8">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-[#D4AF37] rounded-2xl flex items-center justify-center text-white shadow-xl shadow-[#D4AF37]/20">
                        <Gavel size={20} />
                      </div>
                      <h5 className="text-[10px] font-black uppercase tracking-[0.2em] text-[#D4AF37]">Contrato Encerrado</h5>
                    </div>
                    ...
                    {rental.docs?.closureSummary && (
                      <div className="space-y-4">
                        ...
                        <div className="flex gap-2">
                          ...
                          <a href={rental.docs?.terminationTerm ? getFileUrl(rental.docs.terminationTerm) : '#'} target="_blank" rel="noopener noreferrer" download className="flex-1 py-4 bg-[#D4AF37] text-white text-[9px] font-black uppercase tracking-widest rounded-2xl hover:bg-[#0a0a0a] hover:text-white transition-all text-center shadow-xl">Baixar PDF</a>
                        </div>
                      </div>
                    )}
                  </div>
              ...
              <div className="bg-[#0a0a0a] p-8 rounded-3xl border border-neutral-800 shadow-sm space-y-8">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {[
                    ...
                    <div key={i} className={`p-4 rounded-2xl border-2 border-neutral-50 flex flex-col items-center gap-3 transition-all ${doc.file ? 'bg-black hover:border-[#D4AF37]/30 cursor-pointer' : 'opacity-40 pointer-events-none'}`} onClick={() => doc.file && handlePreview(getFileUrl(doc.file))}>
                      <div className="w-8 h-8 rounded-lg bg-[#0a0a0a] flex items-center justify-center text-[#D4AF37] shadow-sm">
                        {doc.icon}
                      </div>
                      <span className="text-[8px] font-black uppercase text-white tracking-widest">{doc.label}</span>
                    </div>
                  ))}
                </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex gap-2 overflow-x-auto pb-2">
                      {(rental.docs.appPrints || rental.docs.app_prints).map((print, i) => (
                        <div key={i} className="w-14 h-14 rounded-xl overflow-hidden shrink-0 border border-neutral-800 cursor-pointer hover:opacity-80 flex items-center justify-center bg-black" onClick={() => handlePreview(getFileUrl(print))}>
                          {isPdfFile(print) ? (
                            <div className="w-full h-full flex items-center justify-center bg-red-500/10 text-red-600">
                              <FileText size={20} />
                            </div>
                          ) : (
